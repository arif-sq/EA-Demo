...
public class OnePageNav {
	...
	public static void OnePageNav() throws InterruptedException {
		...
		assertEquals(Driver.findElement(By.xpath(OnePageNavUtils.Locator.style_1)).getText(),
				OnePageNavUtils.Text.style_1);
		Thread.sleep(3000);

		Driver.findElement(By.xpath(OnePageNavUtils.Locator.features)).click();
		assertEquals(Driver.findElement(By.xpath(OnePageNavUtils.Locator.style_2)).getText(),
				OnePageNavUtils.Text.style_2);
		Thread.sleep(3000);
		...
		assertEquals(Driver.findElement(By.xpath(OnePageNavUtils.Locator.style_3)).getText(),
				OnePageNavUtils.Text.style_3);
		Thread.sleep(3000);

		Driver.findElement(By.xpath(OnePageNavUtils.Locator.p_plan)).click();
		assertEquals(Driver.findElement(By.xpath(OnePageNavUtils.Locator.style_4)).getText(),
				OnePageNavUtils.Text.style_4);
		Thread.sleep(3000);

		Driver.findElement(By.xpath(OnePageNavUtils.Locator.blog)).click();
		assertEquals(Driver.findElement(By.xpath(OnePageNavUtils.Locator.style_5)).getText(),
				OnePageNavUtils.Text.style_5);
		Thread.sleep(3000);
