...
public class AdvancedDataTable {
	...
	public static void AdvancedDataTable() throws InterruptedException {
		...
		assertEquals(Driver.findElement(By.xpath(AdvancedDataTableUtils.Locator.common_desc)).getText(),
				AdvancedDataTableUtils.Text.common_desc);
		...
		assertEquals(Driver.findElement(By.xpath(AdvancedDataTableUtils.Locator.style_1_desc)).getText(),
				AdvancedDataTableUtils.Text.style_1_desc);
		...
		Thread.sleep(2000);
		assertEquals(Driver.findElement(By.xpath(AdvancedDataTableUtils.Locator.style_1_data)).getText(),
				AdvancedDataTableUtils.Text.style_1_data);
		...
		assertEquals(Driver.findElement(By.xpath(AdvancedDataTableUtils.Locator.style_2_desc)).getText(),
				AdvancedDataTableUtils.Text.style_2_desc);
		// Driver.findElement(By.xpath(AdvancedDataTableUtils.Locator.style_2_sorting)).click();
		assertEquals(Driver.findElement(By.xpath(AdvancedDataTableUtils.Locator.style_2_data)).getText(),
				AdvancedDataTableUtils.Text.style_2_data);
