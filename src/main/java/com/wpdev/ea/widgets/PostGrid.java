...
public class PostGrid {
	...
	public static void PostGrid() throws InterruptedException {
		...
		assertEquals(Driver.findElement(By.xpath(PostGridUtils.Locator.style_2_header)).getText(),
				PostGridUtils.Text.style_2_header);
		assertEquals(Driver.findElement(By.xpath(PostGridUtils.Locator.style_2_data_1)).getText(),
				PostGridUtils.Text.style_2_data_1);
		assertEquals(Driver.findElement(By.xpath(PostGridUtils.Locator.style_2_data_1_author)).getText(),
				PostGridUtils.Text.style_2_data_1_author);
		assertEquals(Driver.findElement(By.xpath(PostGridUtils.Locator.style_2_data_2)).getText(),
				PostGridUtils.Text.style_2_data_2);
		assertEquals(Driver.findElement(By.xpath(PostGridUtils.Locator.style_2_data_2_author)).getText(),
				PostGridUtils.Text.style_2_data_2_author);

		JavascriptExecutor style_3 = (JavascriptExecutor) Driver;
		style_3.executeScript("window.scrollTo(0,5100)", "");
		assertEquals(Driver.findElement(By.xpath(PostGridUtils.Locator.style_3_header)).getText(),
				PostGridUtils.Text.style_3_header);
		assertEquals(Driver.findElement(By.xpath(PostGridUtils.Locator.style_3_data_1)).getText(),
				PostGridUtils.Text.style_3_data_1);
		assertEquals(Driver.findElement(By.xpath(PostGridUtils.Locator.style_3_data_2)).getText(),
				PostGridUtils.Text.style_3_data_2);
