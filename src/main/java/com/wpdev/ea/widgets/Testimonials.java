...
public class Testimonials {
	...
	public static void Testimonials() throws InterruptedException {
		...
		assertEquals(Driver.findElement(By.xpath(TestimonialsUtils.Locator.style_1_name)).getText(),
				TestimonialsUtils.Text.style_1_name);
		assertEquals(Driver.findElement(By.xpath(TestimonialsUtils.Locator.style_1_desg)).getText(),
				TestimonialsUtils.Text.style_1_desg);
		assertEquals(Driver.findElement(By.xpath(TestimonialsUtils.Locator.style_1_desc)).getText(),
				TestimonialsUtils.Text.style_1_desc);
		...
		assertEquals(Driver.findElement(By.xpath(TestimonialsUtils.Locator.style_2_name)).getText(),
				TestimonialsUtils.Text.style_2_name);
		assertEquals(Driver.findElement(By.xpath(TestimonialsUtils.Locator.style_2_desg)).getText(),
				TestimonialsUtils.Text.style_2_desg);
		assertEquals(Driver.findElement(By.xpath(TestimonialsUtils.Locator.style_2_desc)).getText(),
				TestimonialsUtils.Text.style_2_desc);
		...
		assertEquals(Driver.findElement(By.xpath(TestimonialsUtils.Locator.style_4_name)).getText(),
				TestimonialsUtils.Text.style_4_name);
		assertEquals(Driver.findElement(By.xpath(TestimonialsUtils.Locator.style_4_desg)).getText(),
				TestimonialsUtils.Text.style_4_desg);
		assertEquals(Driver.findElement(By.xpath(TestimonialsUtils.Locator.style_4_desc)).getText(),
				TestimonialsUtils.Text.style_4_desc);
