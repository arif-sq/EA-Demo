...
public class FeatureList {
	...
	public static void FeatureList() throws InterruptedException {
		...
		Thread.sleep(2000);
		assertEquals(Driver.findElement(By.xpath(FeatureListUtils.Locator.style_1_header)).getText(), FeatureListUtils.Text.style_1_header);
		assertEquals(Driver.findElement(By.xpath(FeatureListUtils.Locator.style_1_desc)).getText(), FeatureListUtils.Text.style_1_desc);
		Driver.findElement(By.xpath(FeatureListUtils.Locator.style_1_icon)).isDisplayed();
		assertEquals(Driver.findElement(By.xpath(FeatureListUtils.Locator.style_1_data_1)).getText(), FeatureListUtils.Text.style_1_data_1);
		Driver.findElement(By.xpath(FeatureListUtils.Locator.style_1_data_1_icon)).isDisplayed();
		assertEquals(Driver.findElement(By.xpath(FeatureListUtils.Locator.style_1_data_2)).getText(), FeatureListUtils.Text.style_1_data_2);
		Driver.findElement(By.xpath(FeatureListUtils.Locator.style_1_data_2_icon)).isDisplayed();
		
		//STYLE 2
		JavascriptExecutor Style_2 = (JavascriptExecutor) Driver;
		Style_2.executeScript("window.scrollTo(0,1700)");
		Thread.sleep(2000);
		assertEquals(Driver.findElement(By.xpath(FeatureListUtils.Locator.style_2_header)).getText(), FeatureListUtils.Text.style_2_header);
		assertEquals(Driver.findElement(By.xpath(FeatureListUtils.Locator.style_2_desc)).getText(), FeatureListUtils.Text.style_2_desc);
		Driver.findElement(By.xpath(FeatureListUtils.Locator.style_2_icon)).isDisplayed();
		assertEquals(Driver.findElement(By.xpath(FeatureListUtils.Locator.style_2_data_1)).getText(), FeatureListUtils.Text.style_2_data_1);
