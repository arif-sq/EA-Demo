...
public class ToolTip {
	...
	public static void ToolTip() throws InterruptedException {
		...
		System.out.println("Now Testing ToolTip Page");
		...
		assertEquals(Driver.findElement(By.xpath(ToolTipUtils.Locator.style_1_header)).getText(), ToolTipUtils.Text.style_1_header);
		assertEquals(Driver.findElement(By.xpath(ToolTipUtils.Locator.style_1_desc)).getText(), ToolTipUtils.Text.style_1_desc);
		...
		assertEquals(Driver.findElement(By.xpath(ToolTipUtils.Locator.style_1_data_1)).getText(), ToolTipUtils.Text.style_1_data_1);
		...
		assertEquals(Driver.findElement(By.xpath(ToolTipUtils.Locator.style_1_data_2)).getText(), ToolTipUtils.Text.style_1_data_2);
		...
		WebElement style_2_data_2 = Driver.findElement(By.xpath(ToolTipUtils.Locator.style_2_data_2_icon));
		mousehover.moveToElement(style_2_data_2).build().perform();
		assertEquals(Driver.findElement(By.xpath(ToolTipUtils.Locator.style_2_data_2)).getText(), ToolTipUtils.Text.style_2_data_2);
	}
}
